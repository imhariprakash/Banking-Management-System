...
<html lang="en">
    ...
    <body class="body-color">
        ...
        <div class="center login-block-color padding">
            <h1 class="center-text">Review application</h1>
            <form onSubmit="return false;">
                <div class=" top-margin">
                    <input type="email" name="email" id="email"
                        placeholder=" Email of applicant" class="input-properties customer_id" required>
                </div>

                <div class="btn btn-success btn-lg adjust-btn" onclick="submit()">Review</div>
            </form>
            <div>
        ...
        function submit(){
            ...
            let url = "http://localhost:8080/abc-bank/admin/review" + "?email=" + email;

            window.location.href = url;
        }

        function back(){
            window.location.href = "http://localhost:8080/abc-bank/login/admin";
        }
    </script>
</html>