    ...
    <body class="body-color">
        ...
        <div class="center login-block-color padding">
            ...
            <form onSubmit="return false;">
                ...
                <div class="btn btn-success btn-lg adjust-btn" onclick="submit()">View</div>
            </form>
            <div>
        ...
        function submit(){
            ...
            let url = "http://localhost:8080/abc-bank/admin/view/customer" + "?account_number=" + account_number;
