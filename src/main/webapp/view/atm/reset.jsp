...
<html lang="en">
    ...
    <body class="body-color">
        ...
        <div class="center login-block-color padding">
            <h1 class="center-text">PIN Reset</h1>
            <form onSubmit="return false;">
                <div class=" top-margin">
                    <input type="text" name="pin" id="pin"
                        placeholder=" New PIN" class="input-properties customer_id" required>
                </div>

                <div class="btn btn-success btn-lg adjust-btn" id="submit" onclick="submit()">Reset</div>
            </form>
        </div>
    </body>
        ...
        <script>
            ...
            function submit(){
                ...
                let url = "http://localhost:8080/abc-bank/atm/reset";
