...
<html lang="en">
    ...
    <body class="body-color">
        ...
        <div class="center login-block-color padding">
            <h1 class="center-text">Withdraw Cash</h1>
            <form onSubmit="return false;">
                ...
                <div class="btn btn-success btn-lg adjust-btn" id="submit" onclick="submit()">Withdraw</div>
            </form>
        </div>
    </body>
        ...
        <script>
            ...
            function submit(){
                ...
                let url = "http://localhost:8080/abc-bank/atm/withdraw";
