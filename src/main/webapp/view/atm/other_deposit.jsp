...
<html lang="en">
    <head>
        ...
        <title>Other Account Deposits</title>
    ...
    <body class="body-color">
        ...
        <div class="center login-block-color padding">
            <h1 class="center-text">Other Account Deposit</h1>
            <form onSubmit="return false;">

                <div class=" top-margin">
                    <input type="text" name="account_number" id="account_number"
                        placeholder=" Account number" class="input-properties customer_id" required>
                </div>
        ...
        <script>
            ...
            function submit(){
                ...
                let url = "http://localhost:8080/abc-bank/atm/deposit/others";
                ...
                let method = "post";
                    ...
                    response.then(function(response){
                        ...
                        if(result.status == 200){
                            ...
                            alert("Successfully deposited " + "₹" + amount + " to the account number " + account_number);
                            window.location.href = "http://localhost:8080/abc-bank/user/atm/";
                        }
                        else{
            ...
            function validateAccountNumber(){
                var accountNumber = document.getElementById("account_number").value.trim().replace("\s", '');
                if(accountNumber == ""){
                    alert("Account number cannot be empty");
                    return false;
                }
                if(/^\d{14}$/.test(accountNumber) == false){
                    alert("Account number should be 14 digits");
                    return false;
                }
                return true;
            }
