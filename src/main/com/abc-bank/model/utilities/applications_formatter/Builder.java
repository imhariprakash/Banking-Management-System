package model.utilities.applications_formatter;
...
public class Builder {
    ...
    public static String build(){
        ...
        ArrayList<Application> applications = dao.utility.GetApplications.getApplications();

        for(Application a : applications) {
                page += "<tr> "
                        + "<td scope=\"col\" > "+ a.getCust_name() +"</td> "
                        + "<td scope=\"col\" >"+ a.getEmail() +"</td> "
                        + " <td scope=\"col\" > "+ a.getPhone() +"</td> "
                        + "<td scope=\"col\" > " + a.getApplied_on() + " </td>"
